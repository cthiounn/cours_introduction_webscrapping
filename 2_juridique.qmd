...
Toutefois, si vous respectez quelques bonnes pratiques de bon sens, votre Webscrapping pourrait être considéré comme tolérable.

## Pourquoi le Webscrapping est interdit ?

Le Webscrapping se heurte à plusieurs risques juridiques : 
